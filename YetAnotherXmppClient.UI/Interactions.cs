...
namespace YetAnotherXmppClient.UI
{
    static class Interactions
    {
        ...
        public static Interaction<IMediator, Unit> ShowMuc { get; } = new Interaction<IMediator, Unit>();
        ...
        public static Interaction<(string RoomJid, string ErrorText), Unit> ShowRoomError { get; } = new Interaction<(string RoomJid, string errorText), Unit>();
    }
}
